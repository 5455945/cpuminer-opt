...
void lyra2z_4way_hash( void *state, const void *input )
{
    ...
    blake256_4way_context _ALIGN(64) ctx_blake;
     ...
     blake256_4way(&ctx_blake, (char*)input + (64 * 4), 16);
...
void lyra2z_8way_hash( void *state, const void *input )
{
    ...
    uint32_t _ALIGN(64) hash2[8];
    uint32_t _ALIGN(64) hash3[8];
    uint32_t _ALIGN(64) hash4[8];
    uint32_t _ALIGN(64) hash5[8];
    uint32_t _ALIGN(64) hash6[8];
    uint32_t _ALIGN(64) hash7[8];
    uint32_t _ALIGN(64) vhash[8 * 8];
    blake256_8way_context _ALIGN(64) ctx_blake;
#else
    uint32_t hash0[8] __attribute__ ((aligned (64)));
    uint32_t hash1[8] __attribute__((aligned(64)));
    uint32_t hash2[8] __attribute__((aligned(64)));
    ...
    blake256_8way_context ctx_blake __attribute__((aligned(64)));
     ...
     blake256_8way(&ctx_blake, (char*)input + (64 * 8), 16);
