 ...
 */
static __inline void __list_add(struct list_head *nlh,
 ...
 */
static __inline void list_add(struct list_head *nlh, struct list_head *head)
{
 ...
 */
static __inline void list_add_tail(struct list_head *nlh, struct list_head *head)
{
